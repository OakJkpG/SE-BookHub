...
const SignupReader = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      await axios.post('https://se-bookhub-be.onrender.com/api/signup/reader/', { 
        username: name,
        email, 
        password 
      });
  ...
  const handleVerificationSubmit = async (e) => {
    ...
    try {
      await axios.post('https://se-bookhub-be.onrender.com/api/signup/reader/verify/', { 
        email, 
  ...
  const resendVerificationCode = async () => {
    ...
    try {
      await axios.post('https://se-bookhub-be.onrender.com/api/signup/reader/resend-code/', { email });
