...
const MainPage = () => {
  ...
  useEffect(() => {
    ...
    Promise.all([
      axios.get('https://se-bookhub-be.onrender.com/api/books/', {
        headers: { Authorization: `Token ${token}` }
      }),
      axios.get('https://se-bookhub-be.onrender.com/api/tags/', {
        headers: { Authorization: `Token ${token}` }
      })
    ])
    ...
    if (role) {
      const userEndpoint = role === 'publisher' 
        ? 'https://se-bookhub-be.onrender.com/api/account/publisher/'
        : 'https://se-bookhub-be.onrender.com/api/account/reader/';
